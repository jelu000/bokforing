    ...
    try{
        ...
        var myTableDiv = document.getElementById("utmatning")
                   ...
                   var stock = new Array()
                    ...
                    if (depositFloat==0)
                        stock.push(new Array("1910", cashFloat, "0"));
                    else if (incomeFloat==depositFloat)
                        stock.push(new Array("1930", depositFloat, "0"));
                    else {
                        stock.push(new Array("1910", cashFloat, "0"));
                        stock.push(new Array("1930", depositFloat, "0"));
                    }

                    stock.push(new Array("2611", "0", taxFloat.toFixed(0)));

                    if (sailsFloat==0)
                      stock.push(new Array("3041", "0" , workIncFloatExTax.toFixed(0)));

                    else if (workIncFloat==0)
                      stock.push(new Array("3051", "0" , sailsFloatExTax.toFixed(0)));
